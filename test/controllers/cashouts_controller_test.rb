...
class CashoutsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cashout" do
    assert_difference('Cashout.count') do
      post cashouts_url, params: { cashout: { amount: @cashout.amount, paid: @cashout.paid, user_id: @cashout.user_id } }
    end
  ...
  test "should update cashout" do
    patch cashout_url(@cashout), params: { cashout: { amount: @cashout.amount, paid: @cashout.paid, user_id: @cashout.user_id } }
